...
.LC1:
	.string	"%f"
.LC3:
	.string	"your height is %.5f cm"
	.text
	.globl	conv_inch_to_cm
	.type	conv_inch_to_cm, @function
conv_inch_to_cm:
.LFB0:
	.file 1 "src/conv_inch_to_centimeter.c"
	.loc 1 17 1
	.cfi_startproc
	pushq	%rbp
...
.L3:
	...
	.cfi_endproc
.LFE0:
	.size	conv_inch_to_cm, .-conv_inch_to_cm
	.section	.rodata
	.align 8
.LC2:
	.long	-2061584302
