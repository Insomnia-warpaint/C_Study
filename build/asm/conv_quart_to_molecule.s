...
.LC1:
	...
	.align 8
.LC3:
	.string	"The quart of water has %lf molecules"
	.text
	.globl	conv_quart_to_mlc
	.type	conv_quart_to_mlc, @function
conv_quart_to_mlc:
.LFB0:
	.file 1 "src/conv_quart_to_molecule.c"
	.loc 1 13 1
	.cfi_startproc
	pushq	%rbp
...
.L3:
	...
	.cfi_endproc
.LFE0:
	.size	conv_quart_to_mlc, .-conv_quart_to_mlc
	.section	.rodata
	.align 8
.LC2:
	.long	1879967165
