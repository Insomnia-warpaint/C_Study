...
.Ltext0:
	...
	.align 8
.LC0:
	.string	"There are %d feet in %d fathoms!\n"
.LC1:
	.string	"Yes, I said %d feet!\n"
	.text
	.globl	fathm_ft_main
	.type	fathm_ft_main, @function
fathm_ft_main:
.LFB0:
	.file 1 "src/fathm_ft.c"
	.loc 1 16 1
	.cfi_startproc
	pushq	%rbp
	...
	.cfi_endproc
.LFE0:
	.size	fathm_ft_main, .-fathm_ft_main
.Letext0:
