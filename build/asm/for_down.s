	...
	.text
.Ltext0:
	.file 0 "/home/insomnia/eclipse-workspace/c-basic" "src/for_down.c"
	.section	.rodata
.LC0:
	.string	"%d seconds!.\n"
.LC1:
	.string	"We have ignition!"
	.text
	.globl	fdown_main
	.type	fdown_main, @function
fdown_main:
.LFB0:
	.file 1 "src/for_down.c"
	.loc 1 16 1
	.cfi_startproc
	pushq	%rbp
