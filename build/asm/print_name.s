...
.LC1:
	.string	"%s"
.LC2:
	.string	"Please type your firstname:"
.LC3:
	.string	"\"%s,%s\""
	.text
	.globl	print_name_main
	.type	print_name_main, @function
print_name_main:
.LFB0:
	.file 1 "src/print_name.c"
	.loc 1 14 1
	.cfi_startproc
	pushq	%rbp
...
.L3:
	...
	.cfi_endproc
.LFE0:
	.size	print_name_main, .-print_name_main
	.section	.rodata
.LC4:
...
.LC7:
	.string	"\"%-*s\"\n"
	.text
	.globl	print_name_align
	.type	print_name_align, @function
print_name_align:
.LFB1:
	.loc 1 29 1
	.cfi_startproc
...
.L6:
	...
	.cfi_endproc
.LFE1:
	.size	print_name_align, .-print_name_align
.Letext0:
