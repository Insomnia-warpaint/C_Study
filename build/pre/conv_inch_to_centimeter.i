# 0 "src/conv_inch_to_centimeter.c"
# 1 "/home/insomnia/eclipse-workspace/c-basic//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/conv_inch_to_centimeter.c"
...
# 9 "src/conv_inch_to_centimeter.c" 2
# 1 "src/../include/bool.h" 1
# 10 "src/conv_inch_to_centimeter.c" 2
...
# 11 "src/conv_inch_to_centimeter.c" 2





# 15 "src/conv_inch_to_centimeter.c"
int
conv_inch_to_cm (void)
{
  float length;
  ...
  scanf ("%f", &length);
  printf ("your height is %.5f cm", (length * 2.54));
