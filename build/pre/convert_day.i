...
# 11 "src/convert_day.c" 2


# 12 "src/convert_day.c"
const int W_RATE = 7;
int
convert_day_main (void)
{
  ...
  while (
# 22 "src/convert_day.c" 3 4
        1
# 22 "src/convert_day.c"
            )
    {
      printf ("type a day: ");
      scanf ("%d", p_day);
 ...
 break;
  ...
  return 
# 35 "src/convert_day.c" 3 4
        1
# 35 "src/convert_day.c"
            ;
}
