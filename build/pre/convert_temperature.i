# 0 "src/convert_temperature.c"
# 1 "/home/insomnia/eclipse-workspace/c-basic//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/convert_temperature.c"
...
# 12 "src/convert_temperature.c" 2


# 13 "src/convert_temperature.c"
struct TEMPARATURE
{
  double fahrenheit;
  double celsius;
...
convert_temperature_main (void)
{
  ...
  if (p_terature == 
# 29 "src/convert_temperature.c" 3 4
                   ((void *)0) 
# 29 "src/convert_temperature.c"
                        || np_terature == 
# 29 "src/convert_temperature.c" 3 4
                                          ((void *)0)
# 29 "src/convert_temperature.c"
                                              )
    {
      ...
      return 
# 32 "src/convert_temperature.c" 3 4
            0
# 32 "src/convert_temperature.c"
                 ;
    }
  ...
  p_terature = 
# 39 "src/convert_temperature.c" 3 4
              ((void *)0)
# 39 "src/convert_temperature.c"
                  ;
  free (p_terature);
  ...
  free (np_terature);
  return 
# 44 "src/convert_temperature.c" 3 4
        1
# 44 "src/convert_temperature.c"
            ;
}
