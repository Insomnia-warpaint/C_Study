...
# 10 "src/greater_ten.c" 2


# 11 "src/greater_ten.c"
int
greater_ten_main (void)
{
  ...
  while (
# 24 "src/greater_ten.c" 3 4
        1
# 24 "src/greater_ten.c"
            )
    {
      printf ("type a num: ");
      scanf ("%d", p_num);
...
increment: ++*p_num;
  ...
  printf ("exit!");
  return 
# 48 "src/greater_ten.c" 3 4
        1
# 48 "src/greater_ten.c"
            ;
}
