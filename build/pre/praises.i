...
praises_main (void)
{
  ...
  scanf ("%s", name);
  printf ("Hello %s . %s", name, "You are extraordinary being");
  printf ("Your name of %zd letters occupies %zd memory cells.\n",
   strlen (name), sizeof(name));
  printf ("The phrase of praise has %zd letters", strlen ("You are extraordinary being"));
  printf ("and occupies %zd memory celles.\n", sizeof("You are extraordinary being"));
